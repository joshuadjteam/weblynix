...
export const LogoIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} viewBox="0 0 162 52" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
        <defs>
            <linearGradient id="logo-bg" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" style={{stopColor: '#0c2a8a'}} />
                <stop offset="100%" style={{stopColor: '#1e40af'}} />
            </linearGradient>
            <style>
                {`.lynix-text { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }`}
            </style>
        </defs>
        <rect width="162" height="52" rx="12" fill="url(#logo-bg)" />
        <circle cx="28" cy="26" r="18" fill="#dbeafe" />
        <path d="M 16 16 L 40 16 L 32 40 L 8 40 Z" fill="#f97316" transform="rotate(10 24 28)" />
        <path d="M 22 22 L 46 22 L 38 46 L 14 46 Z" fill="#ef4444" transform="rotate(10 24 28) translate(0, -2)" />
        <text x="60" y="34" fill="white" fontSize="24" className="lynix-text" fontWeight="500">Lynix</text>
    </svg>
);
...
export const CalculatorIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"></rect><line x1="8" y1="7" x2="16" y2="7"></line><line x1="12" y1="11" x2="12" y2="19"></line><line x1="8" y1="15" x2="16" y2="15"></line></svg>
);

export const SparklesIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L9.5 9.5L3 12l6.5 2.5L12 21l2.5-6.5L21 12l-6.5-2.5L12 3z"/></svg>
);
...
export const KeypadIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10" /><path d="M8 12h.01" /><path d="M12 12h.01" /><path d="M16 12h.01" /><path d="M12 8h.01" /><path d="M12 16h.01" /></svg>
);

export const MicOffIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><line x1="2" x2="22" y1="2" y2="22" /><path d="M18.89 13.23A7.12 7.12 0 0 0 19 12v-2a7 7 0 0 0-14 0v2a7 7 0 0 0 6 6.92" /><path d="M12 19v4" /><path d="M8 23h8" /><path d="M12 5a3 3 0 0 0-3 3v0" /></svg>
);
...
export const HeadsetIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 18 0v7a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3"/><path d="M21 16v-2a3 3 0 0 0-3-3v0a3 3 0 0 0-3 3v2"/></svg>
);